SCENE = {
    ...
    "lines": [
        {"speaker": "Narrador", "text": "Sales de lo que parecía ser una celda"},
    ...
    "choices": [
        {
            "text": "Revisar la celda n.º 002.",
            "target": "scenes.ch3_bed",
            "post_choice_lines": [
                {"speaker": "Narrador", "text": "El otro pasillo no te llama demasiado la atención,"},
                {"speaker": "Narrador", "text": "así que decides continuar hacia la celda 002."},
            ]
        },
        {
